...
- Any release change should be committed with a message that includes its version label, e.g. `v2 release`.
...
- v2 introduces safe bank export to JSON for backup and portability.
