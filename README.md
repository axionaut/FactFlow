...
- Review opens directly as a persisted question stream: all current mistakes first, followed by at most 10 due reinforcements per run. Another incorrect attempt is requeued, and clearing the active run returns to the untouched Today stream.
